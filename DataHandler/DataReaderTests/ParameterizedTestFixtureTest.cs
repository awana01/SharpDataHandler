...
namespace DataHandler.WebDriverTests
{
    ...
    public class ParameterizedTestFixtureTest
    {
        private string eq1;
        private string eq2;
        private string neq;

        public ParameterizedTestFixtureTest(string eq1, string eq2, string neq)
        {
            this.eq1 = eq1;
            this.eq2 = eq2;
            this.neq = neq;
        ...
        public ParameterizedTestFixtureTest(string eq1, string eq2)
            : this(eq1, eq2, null) { }

        public ParameterizedTestFixtureTest(int eq1, int eq2, int neq)
        {
        ...
        public void TestEquality()
        {
            ...
            Console.WriteLine($"param1 {eq1.ToString()}, param2 {eq1.ToString()}");
